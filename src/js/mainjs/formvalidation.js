    function valid(){
      ...
      // for bangla number
      if (regex_number.test(name.value) === false) {
        document.getElementById("name_error").innerHTML =
          "** Only Alphabets is allowed !** **";
        name.focus();
        return false;
      ...
      if (regex.test(name.value) === false) {
        document.getElementById("name_error").innerHTML =
          "** Please enter a valid Name, minimum 4  & maximum 20 Characters **";
        name.focus();
        return false;
      } else {
        document.getElementById("name_error").innerHTML = "";
      ...
      if (regex.test(mother_name.value) === false) {
        document.getElementById("mother_name_error").innerHTML =
          "** Please enter valid Name, minimum 4 & maximum 20 Characters**";
        mother_name.focus();
        return false;
      } else {
        document.getElementById("mother_name_error").innerHTML = "";
      ...
      if (toTimestamp(dob.value) >= currentDate) {
        dob_error.innerHTML =
          "Your Age Should be At least more than 14 Years Old";
        return false;
      }
      if (toTimestamp(dob.value) <= lastDate) {
        dob_error.innerHTML =
          "Your Age Should be At least less than 80 Years Old";
        return false;
      } else {
        dob_error.innerHTML = "";
      }
      ...
      if (exam.value == "") {
        document.getElementById("exam_error").innerHTML =
          "** Please Enter Your SSC Exam Year! **";
        exam.focus();
        return false;
      }
      if (isNaN(exam.value)) {
      ...
      if (exam.value.length != 4) {
        document.getElementById("exam_error").innerHTML =
          " Year is not Valid. Please check";
        return false;
      }
      var current_year = new Date().getFullYear();
      if (exam.value < 1969 || exam.value > current_year) {
        document.getElementById("exam_error").innerHTML =
          "Year should be in range from 1969 to Current year";
        return false;
      } else {
        document.getElementById("exam_error").innerHTML = "";
      }
      ...
      if (last_edu.value == "") {
        document.getElementById("last_edu_error").innerHTML =
          "** Please Enter Your Last Education Level! **";
        last_edu.focus();
        return false;
      }
      ...
      if (regex.test(last_edu.value) === false) {
        document.getElementById("last_edu_error").innerHTML =
          "** Enter Valid Information, minimum 4  & maximum 20 Characters **";
        last_edu.focus();
        return false;
      } else {
        document.getElementById("last_edu_error").innerHTML = "";
      ...
      if (last_edu_ins.value == "") {
        document.getElementById("last_edu_ins_error").innerHTML =
          "** Enter Your Last Educational Instute Name !! **";
        last_edu_ins.focus();
        return false;
      }
      ...
      if (image.value == "") {
        document.getElementById("photo_error").innerHTML =
          "Please Upload Your Photo 300<span>&times;</span>300 Pixels! And File Format must be JPG And Not more than 100 KB";
        image.focus();
        return false;
      } else {
        document.getElementById("photo_error").innerHTML = "";
